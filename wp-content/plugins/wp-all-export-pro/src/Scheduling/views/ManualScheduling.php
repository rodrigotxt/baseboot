<div style="padding-top:11px">
    <label>
        <input type="radio" name="scheduling_enable"
               value="2" <?php if (isset($post['scheduling_enable']) &&  $post['scheduling_enable'] == 2) { ?> checked="checked" <?php } ?>/>
    ...
    <div style="<?php if (isset($post['scheduling_enable']) && $post['scheduling_enable'] != 2) { ?> display: none; <?php } ?>" class="manual-scheduling">
        <p style="margin:0;">
